...
public class DatabaseHandler extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db) {
		...
		String createFriendTable = "CREATE TABLE "+FRIEND_TABLE +"("+COLUMN_FRIEND_NUMBER+" TEXT PRIMARY KEY,"+COLUMN_FRIEND_NAME+" TEXT,"+COLUMN_FRIEND_PIC+" TEXT)";
	...
	public long addFriend(Contact contact){
		...
		return db.insert(FRIEND_TABLE, null, value);
	}
