package com.example.track_me.googleCloudMessaging;
...
import com.example.track_me.HomeActivity;
	...
	class StoreRegistration extends AsyncTask<Void, Void, Boolean>{
		...
		protected Boolean doInBackground(Void... arg0) {
			...
			try {
				...
				Log.i("Gcm response status",status);
				if(status.equals("ok"))
					registered = true;
			} catch (JSONException e) {

				Log.e("Gcm response error", "An error occur", e);
			}
